...
module.exports = {
    ...
    invoke: (conversation, done) => {
        ...
        console.info('SetVariableFromEntityMatches: variable=' + variable + ' nlpVariable=' + nlpVariable + ' entity=' + entity);
        ...
        if (matches.length > 0) {
            console.info('SetVariableFromEntityMatches: setting entity value=' + JSON.stringify(matches[0]));
