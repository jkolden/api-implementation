...
module.exports = {
    ...
    invoke: (conversation, done) => {
        ...
        console.info('TransactionsRetrieval: getting txns for account type ' + accountType +
        ...
        if (date && dateSpecifier) {
            ...
            if (durationFilter) {
                console.info('TransactionsRetrieval: duration=' + JSON.stringify(durationFilter));
            }
        }
        ...
        if (accounts.length > 0) {
            ...
            console.info('TransactionsRetrieval: no accounts of specified type found!');
