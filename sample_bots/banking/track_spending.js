...
module.exports = {
    ...
    invoke: (conversation, done) => {
        ...
        console.info('TrackSpending: getting txns for category=' + spendingCategory + ' date=' + date + ' durationStart=' + durationStart + ' durationEnd=' + durationEnd);
        ...
        if (durationFilter) {
            console.info('TrackSpending: durationFilter=' + JSON.stringify(durationFilter));
        }
        ...
        if (accounts.length > 0) {
            ...
            conversation.reply({ text: 'You\'ve spent $' + (-categoryBalance) + ' on ' + spendingCategory});
        }
        else {
            console.info('TrackSpending: no accounts of specified type found!');
